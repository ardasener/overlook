...
export function paletteCssVars(palette: Palette, uiScale = 1): CSSProperties {
  return {
    ...
    "--ol-modal-bg": palette.bg,
    "--ol-popup-bg": palette.bg,
    "--ol-modal-mask": `color-mix(in srgb, ${palette.bg} 70%, black 30%)`,
    "--ol-modal-mask-opacity": "0.45",
